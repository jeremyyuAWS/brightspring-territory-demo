...
export const TERRITORIES: Territory[] = [
  {
    ...
    baseline: { accountCount: 11, priorityCoveragePct: 88, visitsCompleted: 18, visitsTarget: 20, referrals: 8, driveHrs: 6.2, uncoveredPriority: 1, capacityPct: 84, dims: dims(88, 90, 80, 85, 78) },
    optimized: { accountCount: 11, priorityCoveragePct: 100, visitsCompleted: 18, visitsTarget: 20, referrals: 8, driveHrs: 6.1, uncoveredPriority: 0, capacityPct: 84, dims: dims(100, 90, 82, 86, 80) },
  },
  {
    ...
    baseline: { accountCount: 10, priorityCoveragePct: 88, visitsCompleted: 17, visitsTarget: 18, referrals: 7, driveHrs: 5.8, uncoveredPriority: 1, capacityPct: 76, dims: dims(88, 94, 75, 82, 80) },
    optimized: { accountCount: 11, priorityCoveragePct: 100, visitsCompleted: 18, visitsTarget: 19, referrals: 7, driveHrs: 6.0, uncoveredPriority: 0, capacityPct: 78, dims: dims(100, 94, 76, 83, 80) },
  },
  {
    ...
    optimized: { accountCount: 12, priorityCoveragePct: 85, visitsCompleted: 16, visitsTarget: 18, referrals: 6, driveHrs: 7.1, uncoveredPriority: 2, capacityPct: 92, dims: dims(85, 88, 70, 80, 75) },
  },
  {
    ...
    baseline: { accountCount: 9, priorityCoveragePct: 86, visitsCompleted: 13, visitsTarget: 18, referrals: 5, driveHrs: 8.1, uncoveredPriority: 1, capacityPct: 94, dims: dims(86, 72, 60, 65, 55) },
    optimized: { accountCount: 9, priorityCoveragePct: 86, visitsCompleted: 16, visitsTarget: 18, referrals: 6, driveHrs: 7.4, uncoveredPriority: 1, capacityPct: 88, dims: dims(86, 89, 70, 80, 76) },
  },
  {
    ...
    baseline: { accountCount: 9, priorityCoveragePct: 83, visitsCompleted: 15, visitsTarget: 17, referrals: 6, driveHrs: 6.7, uncoveredPriority: 1, capacityPct: 88, dims: dims(83, 88, 70, 78, 78) },
    optimized: { accountCount: 9, priorityCoveragePct: 83, visitsCompleted: 15, visitsTarget: 17, referrals: 6, driveHrs: 6.6, uncoveredPriority: 1, capacityPct: 86, dims: dims(83, 88, 72, 80, 78) },
  },
]
